...
$(document).ready(function() {
	...
	function centerBox(elem) {
		...
		/* Move stuff about */
		$('.popup-box').css({'height':700, 'width' : boxWidth+'px', 'left' : disWidth+'px', 'top' : disHeight+'px'});
	...
	$('[class*=popup-link]').click(function(e) {
        ...
        // alert("clicked");
        //Build Bootstrap Modal and show article content

        
		
		/* Get the id (the number appended to the end of the classes) */
		var name = $(this).attr('class');
		var id = name.split("-")[name.split("-").length - 1];
