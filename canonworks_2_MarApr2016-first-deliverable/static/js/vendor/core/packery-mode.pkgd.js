...
/**
 * binds DraggaUsery events
 * @param {DraggaUsery} draggie
 */
Packery.prototype.bindDraggaUseryEvents = function( draggie ) {
  draggie.on( 'dragStart', this.handleDraggaUsery.dragStart );
  draggie.on( 'dragMove', this.handleDraggaUsery.dragMove );
  draggie.on( 'dragEnd', this.handleDraggaUsery.dragEnd );
};
